...
void getHistory(StateSetter setState) {
  if (Infomation.historyList.length > 1  && Infomation.tmp_historyList.length > 1 && Infomation.selected_historyList.length > 1) {
    setState(() {
  ...
  } else if(Infomation.historyList.length == 1 && Infomation.tmp_historyList.length == 1 && Infomation.selected_historyList.length == 1) {
    setState(() {
